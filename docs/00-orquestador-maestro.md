...
|---|---|---|---|---|
| 0 Gobierno | IN_REVIEW | Desarrollo | pendiente | docs/, charter y acta listos; faltan verificaciones git locales (ver `gate-0-acta-cierre.md`) |
| 1 Requerimientos | APPROVED | Desarrollo + académico | aprobado c/obs. | `02-requirements.md`, `03-content-inventory.md`; datos faltantes no bloqueantes |
| 2 IA | APPROVED | Desarrollo | aprobado | `04-information-architecture.md` |
| 3 UX | APPROVED | Desarrollo | aprobado | `05-view-specifications.md` + `views/` |
| 4 UI | APPROVED | Desarrollo | aprobado | `06-design-system.md` v1.2; benchmark en `09-benchmark-ux-theochem.md` |
| 5 Arquitectura técnica | APPROVED | Desarrollo | aprobado | `07`, `08`, ADR-001…006 |
| 6 Foundation | APPROVED | Desarrollo | aprobado | build + check limpios; Lighthouse 98–100 |
| 7 Vistas | IN_REVIEW | Desarrollo | pendiente | 9 vistas ES/EN; v1.2 con figuras reales, carruseles y animaciones; Lighthouse 99–100 / a11y 100; falta revisión del responsable |
| 8 Contenido/i18n | IN_PROGRESS | Mixto | pendiente | contenido en borrador; ver matriz de faltantes |
| 9 QA | NOT_STARTED | Desarrollo | pendiente | checklists en `docs/qa/` con avance |
